    ...
    <div className='modal-register__overlay' onClick={handleBackdropClick}>
      <div className='modal-register__container'>
        <div className="modal-register__header">
          <h2 className='modal-register__title title--white'>Вікно реєстрації</h2>
        ...
        <div className="modal-register__body">
          <Formik
              initialValues={{ name: 'dsf', phone: '', wishes: '' }}
              validate={(values) => {
                const errors: any = {}
                if (!values.name) {
            ...
            <Form className="modal-register__form">
                <div className="modal-register__name-wrapper">
                  <label className="modal-register__field">
                    ...
                    <Field className="modal-register__input section__primary-text" type="text" name="name" required placeholder='Петро' />
                  </label>
                  <label className="modal-register__field">
                      <span className="modal-register__label">Призвіще</span>
                      <Field className="modal-register__input section__primary-text" type="text" name="surname" required placeholder='Петренко' />
                  </label>
                </div>
                <div className="modal-register__phone-wrapper">
                  <label className="modal-register__field"
                    ><span className="modal-register__label">Телефон</span>
                      <Field className="modal-register__input section__primary-text" type="text" name="phone" required placeholder='+380 (__) __ __ __'/>
                  </label>
                </div>
                <div className="modal-register__mail-wrapper">
                  <label className="modal-register__field"
                    ><span className="modal-register__label">Електрона пошта</span>
                      <Field className="modal-register__input section__primary-text" type="mail" name="mail" required placeholder='example@mail.com'/>
                  </label>
                </div>
                <div className="modal-register__city-wrapper">
                  <label className="modal-register__field">
                    <span className="modal-register__label">Місто</span>
                    <Field className="modal-register__input section__primary-text" type="text" name="city" required placeholder='Дніпро' />
                  </label>
                  <label className="modal-register__field">
                      <span className="modal-register__label">Сфера бізнесу</span>
                      <Field className="modal-register__input section__primary-text" type="text" name="business" required placeholder='Графічний дизайн' />
