...
function ModalAnalysisThankPending({ onClose }: { onClose: any }) {
  ...
  return (
    <div
      className={`modal-analysisThank__overlay${
        state.isActiveAnalysisThankPendingModal ? " active" : ""
      }`}
    ...
    >
      <div className="modal-analysisThank__container">
        ...
        <div className="modal-analysisThank__body">
          ...
          <p className="modal-analysisThank__text">Очікуйте, будь ласка.</p>
        </div>
      </div>
    </div>
  );
}
export default ModalAnalysisThankPending;
