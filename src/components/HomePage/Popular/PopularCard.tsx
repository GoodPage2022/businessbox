...
const PopularCard = ({image, title, description}: {image: any, title: string, description: string}) => {       
  ...
  return (
    <li className='popular__card'>
      ...
      <div className="popular__card--info">
        ...
        <p className='popular__card--description section__secondary-text'>{description}</p>
